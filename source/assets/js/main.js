  ...
  getEventFeed: function getEventFeed() {
    ...
    function printCal(data, container) {
      ...
      data.forEach(function (dataEl) {
        ...
        '</span></div></div>	<div class="event-content"><h4>' + '<a href="' + dataEl.permaLinkUrl + '">' + dataEl.title + '</a></h4>    <p><span class="caltime">' + timeStr + '<br></span><span class="callocation">' + dataEl.location + // Campus-wide
        '</span>    </p>	</div></div></div>');
      });
    }
