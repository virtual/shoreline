@include ('_partials.subfooter')
<footer id="footer" class="bg-inverted bg-primary">
          ...
          <div class="footer-map">
            <div class="bg-offset-bottom-right bg-offset-yellow-wave">
              <a href="https://www.shoreline.edu/map/directions-to-campus.aspx">
                <span class="location-square-feature lazy" data-bg="{{ $page->baseUrl }}/resources/img/graphics/shoreline-custom-map-light.jpg">
