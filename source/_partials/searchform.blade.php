<form class="siteSearch" role="search" method="GET" action="/search/SearchRedir.aspx">
  <div class="input-group main-search" role="search">
    ...
    <label><span class="sr-only">Enter search terms</span>
    <input type="search" name="EnterSearch" class="entersearch form-control py-2 border-left-0 border" placeholder="Search"
      value=""></label>
