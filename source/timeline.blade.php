 ...
 <h1>Timeline</h1> 
  <div class="timeline">
    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        'heading' => 'Build components & templates (June 5–Sept 13, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Accessibility review (Aug 20–Sept 3, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Finalize program options in multiedit (Sept 3, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Acalog goes live  (Sept 1–30, 2018)',
        'desc' => "
        ",
        'id' => '4', 
        'img' => ''
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Code review (Sept 13–27, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Deadline for Program Option info and department pages (Sept 24, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Backup test site in OU Campus (Sept 28, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Code updates (Sept 28–Oct 5, 2018)',
        'desc' => "Dev fixes.
        ",
        'id' => '7d', 
        'img' => ''
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Duplicate www site to test site in OU Campus (Oct 1–5, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Implement code on test server (Oct 8-12, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Review and test existing content into updated templates (Oct 15–19, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Code updates (Oct 22–26, 2018)',
        'desc' => "Dev fixes.
        ",
        'id' => '7a', 
        'img' => ''
        ...
        @include('_partials.timelinelist', [
        'heading' => 'Implementation process for new theme on www; republish website (early Nov 5, 2018)',
        ...
        @include('_partials.timelinelist', [
        'heading' => 'OU Migration for Program options and department pages (Nov 6-9, 2018)',
